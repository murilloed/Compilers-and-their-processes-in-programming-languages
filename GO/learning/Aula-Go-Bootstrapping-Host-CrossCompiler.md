...
![Visão geral do bootstrapping e compilação Go](assets/go-bootstrapping-visao-geral.png)
...
![Bootstrapping com Diagramas em T](assets/go-bootstrapping-diagrama-t.png)
